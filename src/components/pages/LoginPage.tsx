            ...
            {mode === 'forgotPassword' ? (
              <div className="space-y-6" onKeyDown={handleKeyDown}>
                <div className="login-card-stagger">
                  <h2 className="login-card-title text-2xl font-bold text-[#FAF3E0]">Reset password</h2>
              ...
              <div className="space-y-6 text-center">
                ...
                <div className="login-card-stagger">
                  <h2 className="login-card-title text-2xl font-bold text-[#FAF3E0]">Registration submitted</h2>
              ...
              <div className="space-y-6" onKeyDown={handleKeyDown}>
                <div className="login-card-stagger">
                  <h2 className="login-card-title text-2xl font-bold text-[#FAF3E0]">
