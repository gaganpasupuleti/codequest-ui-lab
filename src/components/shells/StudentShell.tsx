...
export function StudentShell({ currentPage, user, onNavigate, onLogout, children }: StudentShellProps) {
  ...
  const canvasBg = isCreamPage ? 'bg-[#F2EBD6]' : isWorkbench ? 'bg-[#0B1020]' : 'bg-slate-50'
      ...
      <div className="relative flex min-w-0 flex-1 flex-col">
        ...
        <div
          className={cn(
            ...
            isCreamPage
              ? 'border-[#0A1020]/10 bg-[#F2EBD6]'
              : isWorkbench
                ? 'border-[#26324A] bg-[#0F172A]'
                : 'border-slate-200 bg-[#FFFDF6]',
          )}
        >
          ...
          <button
            ...
            className={cn(
              'rounded-lg p-1.5 outline-none focus-visible:ring-2 focus-visible:ring-blue-400/50 lg:hidden',
              isWorkbench
