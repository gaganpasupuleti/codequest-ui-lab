...
export function DashboardTopHeader({
  ...
  return (
    <header className="relative overflow-hidden rounded-2xl border border-[#0A1020]/15 bg-[#0A1020] px-5 py-5 text-[#FAF3E0] shadow-[0_18px_44px_-28px_rgba(10,16,32,0.8)] md:px-6 md:py-5">
      {/* soft accent glows */}
      <div
        aria-hidden
      ...
      <div className="relative flex flex-col gap-3.5 lg:flex-row lg:items-center lg:justify-between lg:gap-5">
        <div className="min-w-0 flex-1 space-y-2.5">
          ...
          <div className="min-w-0">
            <h1 className="font-serif text-[24px] font-semibold leading-tight tracking-tight text-[#FAF3E0] sm:text-[28px]">
              Your learning command center
            </h1>
            <p className="mt-1 flex items-center gap-2 text-[13px] text-[#FAF3E0]/70">
        ...
        <div className="flex w-full shrink-0 flex-col gap-2.5 lg:w-[300px]">
          <CQActionButton
            ...
            className="w-full justify-between border-transparent bg-[#FAF3E0] px-4 py-2.5 text-[13px] text-[#0A1020] hover:bg-white"
          >
            Continue practice
